...
#
# URL: /api/dialysis-center-search/geopt/34.744963,-87.6754578/format/json
# The service returns dialysis centers by lat/lon
#
...
# class definition
class GetDialysisLocByGeoPtHandler(webapp.RequestHandler):

...
#
# URL: /api/dialysis-center-search/zip/06032/format/json
# The service returns dialysis facilities by zipcode
#
...
# class definition
class GetDialysisLocByZipHandler(webapp.RequestHandler):

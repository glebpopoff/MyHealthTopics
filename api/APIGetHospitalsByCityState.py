...
#
# URL: /api/hospital-search/citystate/farmington%2Cct/format/json
# The service returns hospitals by city & state (e.g. farmington,ct)
#
...
#class definition
class GetHospitalsByCityStateHandler(webapp.RequestHandler):

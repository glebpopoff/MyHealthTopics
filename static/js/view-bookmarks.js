healthguide.views.Bookmarks = Ext.extend(Ext.Panel, {
    layout: 'card',
	fullscreen: true,
    initComponent: function() {
        ...
        this.items = this.listpanel;
       	healthguide.views.Bookmarks.superclass.initComponent.call(this);
    },
...
Ext.reg('bookmarks-screen', healthguide.views.Bookmarks);